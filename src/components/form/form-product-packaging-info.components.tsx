...
export const FormProductPackagingInfo = <T extends FieldValues>({mode, methods, valueInitialStorage}:FormProductPackagingInfoProps<T>) => {
    return(
        <FormSection className="mt-2 md:mt-3 md:flex-row gap-4">
             {/* Armazém */}
             <SafeReviewField field="armazem_padrao" mode={mode || "viewing"}>
                <Input    
            ...
            {/* Tamanho Embalagem */}
            <SafeReviewField field="tamanho_embalagem" mode={mode || "viewing"}>
                <Input    
            ...
            {/*  tipo embalagem*/}
            <SafeReviewField field="tipo_embalagem" mode={mode || "viewing"}>
                <Input    
